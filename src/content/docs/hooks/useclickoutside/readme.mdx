...
```jsx
// ESM
import {useClickOutside, ClickOutside, ClickOutsideOverride} from 'webrix/hooks';
import {useClickOutside, ClickOutside, ClickOutsideOverride} from 'webrix/hooks/useClickOutside'; // For better tree shaking

// UMD
const {useClickOutside, ClickOutside, ClickOutsideOverride} = Webrix.hooks;
```
