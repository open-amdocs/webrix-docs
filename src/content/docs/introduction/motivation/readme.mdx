...
<Layers>
    <Layer text='3rd-Party Bank' gradient={['#3186ab', '#3153AB']} offset={[0, 30, 0]} size={100}/>
    <Layer text='App' gradient={['#11eda1', '#11edda']} offset={[20, 20, 0]} size={60}/>
</Layers>
...
create a component bank that has all the features that you need, nothing more, nothing less.
...
<Layers>
    <Layer text='Stackable' gradient={['#E42746', '#E42795']} offset={[52, 40, 0]}  size={48}/>
    <Layer text='ClickOutside' gradient={['#E42746', '#E42795']} offset={[0, 40, 0]} size={48}/>
    <Layer text='Poppable' gradient={['#E42746', '#E42795']} offset={[26, 50, 0]} size={48}/>
    <Layer text='DropDown' gradient={['#3186ab', '#3153AB']} offset={[0, 10, 0]} size={100}/>
</Layers>