...
```html
<script src="https://unpkg.com/webrix@1.0.0/umd/webrix.umd.js" crossorigin></script>
```

There's also a minified version, recommended for production:

```html
<script src="https://unpkg.com/webrix@1.0.0/umd/webrix.umd.min.js" crossorigin></script>
```
