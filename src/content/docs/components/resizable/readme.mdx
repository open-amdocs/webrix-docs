...
Additionally, constraints can be applied to control the way an element is resized.
The `<Resizable/>` component comes with a set of pre-defined constraints that you can use,
...
<Example file='docs/components/resizable/Contained' height={300}/>
