...
<Example file='docs/components/resizable/CustomConstraints' height={300}/>

You can create your own custom constraints using the `Resizable.createConstraint()` function.
...
Each Resizable event receives 3 arguments:
