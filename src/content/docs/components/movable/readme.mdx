...
and you can execute your logic in each event and even pass data between them.
...
* An object with the data shared between events (in the example we extract `next` from it,
  which contains the next top/left coordinates).
