...
<Example file='components/poppable/BasicExample' height={400}/>
...
<Example file='components/poppable/Context' height={300}/>
...
In the above example you see how a triangle can be positioned between the reference and the target using that context.
...
<Example file='components/poppable/MousePosition' height={300}/>
...
<Example file='components/poppable/ManualControl' height={300}/>
