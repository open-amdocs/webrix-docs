...
<Example file='components/movable/BasicExample' height={200}/>
...
<Example file='components/movable/ConstraintMovement' height={200}/>
...
<Example file='components/movable/Snapping' height={200}/>
...
import Movable from 'webrix/Movable'; // For better tree shaking
```
### Props
