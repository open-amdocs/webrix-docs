...
<Example file='components/scrollable/VerticalScroll' height={300}/>
...
<Example file='components/scrollable/HorizontalScroll' height={250}/>

Same as the previous story, only here the content overflows horizontally.

## Minimal Thumb Size

<Example file='components/scrollable/MinimalThumbSize' height={300}/>
...
<Example file='components/scrollable/ScrollbarShadow' height={300}/>
...
<Example file='components/scrollable/CustomScrollbars' height={300}/>
...
In this example you can see a custom vertical scrollbar, positioned outside of the container, featuring
a vivid gradient.
...
import Scrollable from 'webrix/components/Zoomable'; // For better tree shaking
```
### Props
