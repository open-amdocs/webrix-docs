...
<Example file='components/resizable/BasicExample' height={300}/>
...
<Example file='components/resizable/MinMaxSizes' height={350}/>
...
<Example file='components/resizable/Snapping' height={300}/>
...
<Example file='components/resizable/CustomDirections' height={300}/>
...
import Resizable from 'webrix/Resizable'; // For better tree shaking
```
