...
The `<Collapsible/>` components allows you to collapse/expand an element with arbitrary content height
...
<Example file='components/collapsible/BasicExample' height={300}/>
...
<Example file='components/collapsible/Nesting' height={450}/>
...
import Collapsible from 'webrix/Collapsible'; // For better tree shaking
```
